...
@section('content')
    <div class="row">
        <div class="col-lg-6">
            <h4 class="text-white">{{ __('Data Pengajar') }}</h4>
            <p class="text-white opacity-8">{{ __('Data Pengajar') }}</p>
        </div>
        <div class="col-lg-6 text-right d-flex flex-column justify-content-center">
            <a href="{{ route('pengajar.create') }}"
                ...
                <span id="btnText">{{ __('Tambah Data Pengajar') }}</span></a>
        </div>
    </div>
    @include('Pages.Pengajar.widget', ['pengajar' => $pengajar])
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0" id="DataTable">
                            ...
                            <tbody>
                                @foreach ($pengajar as $index => $item)
                                    <tr>
                                        <td>
                                            ...
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm"><a
                                                            href="{{ route('pengajar.show', $item->id) }}">{{ $item->user->nama_lengkap }}</a>
                                                    </h6>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <a href="{{ route('pengajar.show', $item->id) }}"
