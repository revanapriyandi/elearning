                    ...
                    <div class="card-body p-3 position-relative">
                        <div class="row">
                            <div class="col-8 text-start">
                                ...
                                <span class="text-white text-sm">{{ __('Jumlah Pengajar') }}</span>
                            </div>
                            <div class="col-4">
                                <p class="text-white text-sm text-end font-weight-bolder mt-auto mb-0">
                                    {{ ($pengajar->count() / 100) * 100 }}%
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-3 position-relative">
                        <div class="row">
                            <div class="col-8 text-start">
                                ...
                                <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                    {{ $pengajar->where('user.jenis_kelamin', 'L')->count() }}
                                </h5>
                                <span class="text-white text-sm">{{ __('pengajar Laki Laki') }}</span>
                            </div>
                            <div class="col-4">
                                @if ($pengajar->count() > 0)
                                    <p class="text-white text-sm text-end font-weight-bolder mt-auto mb-0">
                                        {{ ($pengajar->where('user.jenis_kelamin', 'L')->count() / $pengajar->count()) * 100 }}%
                                    </p>
                                @else
                                    <p class="text-white text-sm text-end font-weight-bolder mt-auto mb-0">
                                        0%
                    ...
                    <div class="card-body p-3 position-relative">
                        <div class="row">
                            <div class="col-8 text-start">
                                ...
                                <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                    {{ $pengajar->where('user.jenis_kelamin', 'P')->count() }}
                                </h5>
                                <span class="text-white text-sm">{{ __('Pengajar Perempuan') }}</span>
                            </div>
                            <div class="col-4">
                                @if ($pengajar->count() > 0)
                                    <p class="text-white text-sm text-end font-weight-bolder mt-auto mb-0">
                                        {{ ($pengajar->where('user.jenis_kelamin', 'P')->count() / $pengajar->count()) * 100 }}%
                                    </p>
                                @else
                                    <p class="text-white text-sm text-end font-weight-bolder mt-auto mb-0">
                                        0%
                    ...
                    <div class="card-body p-3 position-relative">
                        <div class="row">
                            <div class="col-8 text-start">
                                ...
                                <h5 class="text-white font-weight-bolder mb-0 mt-3">
                                    {{ $pengajar->where('created_at', '>=', now()->subMonths(6))->count() }}
                                </h5>
                                <span class="text-white text-sm">{{ __('Pengajar baru dalam 6 bulan') }}</span>
                            </div>
                            <div class="col-4">
                                @if ($pengajar->count() > 0)
                                    <p class="text-white text-sm text-end font-weight-bolder mt-auto mb-0">
                                        {{ ($pengajar->where('created_at', '>=', now()->subMonths(6))->count() / $pengajar->count()) * 100 }}%
                                    </p>
                                @else
                                    <p class="text-white text-sm text-end font-weight-bolder mt-auto mb-0">
                                        0%
        ...
        new Chart(ctx1, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderWidth: 3,
                    fill: true,
                    data: {!! json_encode($pengajarCount->values()) !!},
                }],
            },
            options: {
                responsive: true,
